...
# Створюємо пул підключень до бази даних
async def create_db_pool():
    return await asyncpg.create_pool(DATABASE_URL)

# Ініціалізація таблиці для збереження даних бронювання
...
# Генерація меню вибору тривалості
def generate_duration_keyboard():
    keyboard = [["1 година"], ["1.5 години"], ["2 години"], ["Назад"]]
    return ReplyKeyboardMarkup(keyboard, one_time_keyboard=True, resize_keyboard=True)

# Обробка вибору тривалості і збереження бронювання
